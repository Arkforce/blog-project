...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Tech1234',
        'HOST': 'database1.ce3l9gxhoovh.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'blog-s3-web' # please enter your s3 bucket name
