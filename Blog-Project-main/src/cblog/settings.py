...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Tech1234',
        'HOST': 'database1.caumocpqz6im.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'project-blog-s3' # please enter your s3 bucket name
